...
namespace Project.Controllers
{
    public class InternetBankingController : Controller
    {
        ...
        [HttpPost]
        public ActionResult ChangeLoginPassword(int accountNo, string oldPassword, string newPassword)
        {
            string msg = internetBankingService.ChangeLoginPassword(accountNo, oldPassword, newPassword);
            ViewBag.Message = msg;
        ...
        [HttpPost]
        public ActionResult ChangeTransactionPassword(int accountNo, string oldPassword, string newPassword)
        {
            string msg = internetBankingService.ChangeTransactionPassword(accountNo, oldPassword, newPassword);
            ViewBag.Account = Session["Account"];
            ViewBag.Message = msg;
            return View();
        }
