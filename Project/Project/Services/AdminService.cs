...
namespace Project.Services
{
    public class AdminService
    {
        ...
        public (int supportId, string message) RaiseSupportMessage(SupportMessage supportMessage)
        {
            ...
            try
            {
                //var result = db.Sp_RaiseSupportMessage(supportMessage.UserEmail, supportMessage.Subject, supportMessage.Message);
                //System.Diagnostics.Debug.WriteLine(supportMessage.UserEmail + " " + supportMessage.Subject + " " + supportMessage.Message);
                //db.SupportMessages.SqlQuery("INSERT INTO SupportMessages (UserEmail, Subject, Message, SentAt, Status) VALUES (@UserEmail, @Subject, @Message, GETDATE(), 'Pending')", new SqlParameter("@UserEmail", supportMessage.UserEmail), new SqlParameter("@Subject", supportMessage.Subject), new SqlParameter("@Message", supportMessage.Message));
