...
update Internet_Banking_Details set Email_Id = 'hemasaibonda1@gmail.com' where Account_Number = 10002
...
update Internet_Banking_Details set is_locked = 0 where Account_Number = 10002
update Internet_Banking_Details set failed_attempts = 0 where Account_Number = 10002
...
insert into admin_table (name, email_id, password) values ('admin', 'admin@gmail.com', 'admin@123')
...
delete from Internet_Banking_Details where Account_Number = 10001 or Account_Number = 10002
delete from Debit_Card_Details where Account_Number = 10001 or Account_Number = 10002