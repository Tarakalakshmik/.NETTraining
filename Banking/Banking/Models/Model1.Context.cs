...
namespace Banking.Models
{
    ...
    public partial class BankingDBEntities1 : DbContext
    {
        public BankingDBEntities1()
            : base("name=BankingDBEntities1")
        {
        }
        ...
        public virtual DbSet<ChatSupport> ChatSupports { get; set; }
        ...
        [DbFunction("BankingDBEntities1", "fn_AdminLogin")]
        public virtual IQueryable<fn_AdminLogin_Result> fn_AdminLogin(string email, string password)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_AdminLogin_Result>("[BankingDBEntities1].[fn_AdminLogin](@email, @password)", emailParameter, passwordParameter);
        }
    
        [DbFunction("BankingDBEntities1", "fn_GetPayee")]
        public virtual IQueryable<fn_GetPayee_Result> fn_GetPayee(Nullable<int> payee_Id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetPayee_Result>("[BankingDBEntities1].[fn_GetPayee](@Payee_Id)", payee_IdParameter);
        }
    
        [DbFunction("BankingDBEntities1", "fn_GetStatement")]
        public virtual IQueryable<fn_GetStatement_Result> fn_GetStatement(Nullable<int> account_number, Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_GetStatement_Result>("[BankingDBEntities1].[fn_GetStatement](@Account_number, @from_date, @to_date)", account_numberParameter, from_dateParameter, to_dateParameter);
        }
        ...
        public virtual int Sp_AddTransaction(Nullable<int> from_Account, Nullable<int> to_Account, string transaction_Mode, string transaction_Type, Nullable<int> amount, Nullable<System.DateTime> transaction_Date, string remarks)
        {
            var from_AccountParameter = from_Account.HasValue ?
                new ObjectParameter("From_Account", from_Account) :
                new ObjectParameter("From_Account", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Sp_AddTransaction", from_AccountParameter, to_AccountParameter, transaction_ModeParameter, transaction_TypeParameter, amountParameter, transaction_DateParameter, remarksParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> Sp_RaiseSupportRequests(string from_Email, string to_Email, string subject, string message)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("Sp_RaiseSupportRequests", from_EmailParameter, to_EmailParameter, subjectParameter, messageParameter);
        }
